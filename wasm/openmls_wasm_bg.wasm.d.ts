...
export const identity_from_bytes: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const identity_serialize: (a: number) => [number, number, number, number];
...
export const provider_serialize: (a: number) => [number, number];
